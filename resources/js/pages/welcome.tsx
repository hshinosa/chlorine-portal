...
// Blog related imports removed per request
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">Welcome to Chlorine Portal</h1>
                            <p className="mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                                    Explore certifications, videos, and internship opportunities.
                                </p>
                                <ul className="mb-6 space-y-3 text-sm leading-normal">
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 inline-block h-2 w-2 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                        <span>
                                            Browse certifications at
                                            <Link
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1 inline-block h-2 w-2 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                        <span>
                                            Find internship positions on the
                                            <Link
